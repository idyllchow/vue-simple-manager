    ...
    <div class="deploy">
      ...
      <el-form ref="form" :model="form" label-width="80px" @submit.prevent="onSubmit" style="margin:20px;width:60%;min-width:600px;">
        <el-form-item label="应用名称">
          <el-select v-model="form.appname" placeholder="请选择发布应用">
            <el-option label="实地通" value="sloa"></el-option>
            <el-option label="应用2" value="sltoken"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="系统平台">
          <el-select v-model="form.platform" placeholder="请选择发布平台">
            <el-option label="Android" value="Android"></el-option>
            <el-option label="iOS" value="iOS"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="版本号">
          <el-input v-model="form.version" name="version" placeholder="请输入发布版本号"></el-input>
        </el-form-item>
        <el-form-item label="强制更新">
          <el-switch on-text="" off-text="" v-model="form.upgradetype"></el-switch>
        </el-form-item>
        <el-form-item label="A/B用户">
          <el-autocomplete v-model="form.oauser" name="oauser" :fetch-suggestions="querySearchAsync"  @select="handleSelect" placeholder="请输入灰度用户名"></el-autocomplete>
        </el-form-item>
        <el-form-item label="更新提示">
          <el-input type="textarea" :rows=5 v-model="form.changelog" ></el-input>
        </el-form-item>
        <el-form-item>
